...
(function(t) {
  ...
  e.prototype.init = function() {
    ...
    if (typeof this.options.refresh === "function") t = {
      callback: this.options.refresh
    };
    this.refresh = this.merge({
      offset: 60
    }, t);
    var e = this.options.loading;
    if (typeof this.options.loading === "function") e = {
      callback: this.options.loading
    };
    this.loading = this.merge({
      offset: 60
    }, e);
    this.initDownScroll()
  };
  ...
  e.prototype.getPoint = function(t) {
    return {
      x: t.touches ? t.touches[0].pageX : t.clientX,
      y: t.touches ? t.touches[0].pageY : t.clientY
    }
  };
  ...
  if (typeof require === "function" && typeof module === "object" && module && typeof exports === "object" && exports) module.exports = e;
