<template>
    <div>
        <common-header :currentTab.sync="activeTab" :tabClick="tabIndexChange" :priceSort="sortTicker"
                       :sortPlatForm="sortPlat" :currency="setCurrencyId" ref="commonHeader"></common-header>
        <scroll :mescroll.sync="meInstance" :scrollData="scrollList" :isChoiceType="isChoice" :downCb="getData"
                :upCb="getData" :currItem="currentItem" :scrollBoxShow="activeTab" ref="scroller">
        </scroll>
