        ...
        <div class="mine">
            <yd-cell-group>
              ...
              <img src="../../assets/default_avatar_male.jpg" alt="" style="background-size: 100% 100% " v-else>
                ...
                <yd-cell-item arrow
                              @click.native="$router.replace({path:'/updateUserInfo',query:{type:'phone',val:userInfo.phone}})">
                ...
                <yd-cell-item arrow
                              @click.native="$router.replace({path:'/updateUserInfo',query:{type:'sex',val:userInfo.xingbie==1?'男':'女'}})">
